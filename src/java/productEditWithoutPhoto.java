 ...
 * @author lenovo
 */
public class productEditWithoutPhoto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String brand = request.getParameter("brand");
            ...
            //database query 
            ResultSet rs = DBLoader.executeQuery("select * from products where productid="+pid);
            String answer = "";
            if (rs.next())
            {
                rs.updateString("productname", product);
