 ...
 */
@MultipartConfig
public class addCategoriesResponse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            //database query 
            ResultSet rs = DBLoader.executeQuery("select * from categories where catname='" + categoryName + "'");
            String answer = "";
            if (rs.next())
            {
                answer = "fail";
            ...
            } else
            {
                ...
                rs.moveToInsertRow();
                rs.updateString("catname", categoryName);
